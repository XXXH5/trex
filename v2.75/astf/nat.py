...
class Prof1():
    ...
    def create_profile(self):
        ...
        profile = ASTFProfile(default_ip_gen=ip_gen, cap_list=[
            ...
            #ASTFCapInfo(file="../avl/delay_10_rtp_160k_0.pcap", cps=0.7*2),
            #ASTFCapInfo(file="../avl/delay_10_rtp_160k_1.pcap", cps=0.7),
            #ASTFCapInfo(file="../avl/delay_10_rtp_250k_0_0.pcap", cps=0.5*2),
            #ASTFCapInfo(file="../avl/delay_10_rtp_250k_1_0.pcap", cps=0.5),

            #ASTFCapInfo(file="../avl/delay_10_smtp_0.pcap", cps=1.85*3),
